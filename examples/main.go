...
import (
	...
	"github.com/overlay-labs/goth/providers/apple"
	"github.com/overlay-labs/goth/providers/yandex"
	...
	"github.com/overlay-labs/goth/gothic"
	"github.com/overlay-labs/goth/providers/amazon"
	"github.com/overlay-labs/goth/providers/auth0"
	"github.com/overlay-labs/goth/providers/azuread"
	"github.com/overlay-labs/goth/providers/battlenet"
	"github.com/overlay-labs/goth/providers/bitbucket"
	"github.com/overlay-labs/goth/providers/box"
	"github.com/overlay-labs/goth/providers/dailymotion"
	"github.com/overlay-labs/goth/providers/deezer"
	"github.com/overlay-labs/goth/providers/digitalocean"
	"github.com/overlay-labs/goth/providers/discord"
	"github.com/overlay-labs/goth/providers/dropbox"
	"github.com/overlay-labs/goth/providers/eveonline"
	"github.com/overlay-labs/goth/providers/facebook"
	"github.com/overlay-labs/goth/providers/fitbit"
	"github.com/overlay-labs/goth/providers/gitea"
	"github.com/overlay-labs/goth/providers/github"
	"github.com/overlay-labs/goth/providers/gitlab"
	"github.com/overlay-labs/goth/providers/google"
	"github.com/overlay-labs/goth/providers/gplus"
	"github.com/overlay-labs/goth/providers/heroku"
	"github.com/overlay-labs/goth/providers/instagram"
	"github.com/overlay-labs/goth/providers/intercom"
	"github.com/overlay-labs/goth/providers/lastfm"
	"github.com/overlay-labs/goth/providers/line"
	"github.com/overlay-labs/goth/providers/linkedin"
	"github.com/overlay-labs/goth/providers/meetup"
	"github.com/overlay-labs/goth/providers/microsoftonline"
	"github.com/overlay-labs/goth/providers/naver"
	"github.com/overlay-labs/goth/providers/nextcloud"
	"github.com/overlay-labs/goth/providers/onedrive"
	"github.com/overlay-labs/goth/providers/openidConnect"
	"github.com/overlay-labs/goth/providers/paypal"
	"github.com/overlay-labs/goth/providers/salesforce"
	"github.com/overlay-labs/goth/providers/shopify"
	"github.com/overlay-labs/goth/providers/slack"
	"github.com/overlay-labs/goth/providers/soundcloud"
	"github.com/overlay-labs/goth/providers/spotify"
	"github.com/overlay-labs/goth/providers/steam"
	"github.com/overlay-labs/goth/providers/stripe"
	"github.com/overlay-labs/goth/providers/twitch"
	"github.com/overlay-labs/goth/providers/twitter"
	"github.com/overlay-labs/goth/providers/typetalk"
	"github.com/overlay-labs/goth/providers/uber"
	"github.com/overlay-labs/goth/providers/vk"
	"github.com/overlay-labs/goth/providers/wave"
	"github.com/overlay-labs/goth/providers/wepay"
	"github.com/overlay-labs/goth/providers/xero"
	"github.com/overlay-labs/goth/providers/yahoo"
	"github.com/overlay-labs/goth/providers/yammer"
)
